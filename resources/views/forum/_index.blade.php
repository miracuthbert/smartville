...
@section('content')
    ...
    <div id="forumWrapper">
        <div class="container">
            <div class="jumbotron {{ $topics->currentPage() > 1 ? 'hidden' : '' }}">
                <h1>Hello, welcome to Knowledge Base!</h1>
                <p>Here you can browse and ask questions for answers about our products and services, with help from our
                    support center and the community that uses our products.</p>
                <p>
                    <a class="btn btn-primary btn-lg" href="{{ route('forum.create') }}" role="button">Ask a question
                        now</a>
                </p>
            </div>
            <!-- /.jumbotron -->
