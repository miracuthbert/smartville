            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="table-responsive">
                        @if($sort == "trials")
                            @include('admin.company_app.trials'){{-- Trial Subscriptions --}}
                        @elseif($sort == "subscribed" && $trial == 1)
                            @include('admin.company_app.apps_on_trial'){{-- Apps On Trial --}}
                        @elseif($sort == "subscriptions")
                            @include('admin.company_app.subscriptions'){{-- Paid Subscriptions --}}
                        @elseif($sort == "subscribed" && $trial == 0)
                            @include('admin.company_app.apps_paid_subscriptions'){{-- Apps On Paid Subscriptions --}}
                        @else
                            @include('admin.company_app.all')
                        @endif
