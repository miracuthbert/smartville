...
@section('content')
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"><i class="fa fa-th-large"></i> Amenities
                        <a href="{{ route('hostel.amenity.create') }}" class="btn btn-primary btn-sm rounded-s">
                            Add New
                        </a>
                        <!-- Create -->
            ...
            <li class="item">
                <div class="item-row">
                    ...
                    <div class="item-col fixed item-col-img md">
                        <a href="{{ route('hostel.amenity.edit', ['amenity' => 'id']) }}">
                    ...
                    <div class="item-col fixed pull-left item-col-title">
                        ...
                        <div>
                            <a href="{{ route('hostel.amenity.edit', ['amenity' => 'id']) }}" class="">
                        ...
                        <div class="item-actions-dropdown"><a class="item-actions-toggle-btn">
                            ...
                            <div class="item-actions-block">
                                <ul class="item-actions-list">
                                    ...
                                    <li><a class="edit"
                                           href="{{ route('hostel.amenity.edit', ['amenity' => 'id']) }}">
