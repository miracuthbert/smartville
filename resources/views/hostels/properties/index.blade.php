...
@section('content')
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"><i class="fa fa-building"></i> Properties
                        <a href="{{ route('hostel.property.create') }}" class="btn btn-primary btn-sm rounded-s">
                            Add New
                        </a>
                        <!-- Create -->
                        <div class="action dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu1"><a class="dropdown-item"
                                        ...
                                        class="dropdown-item" href="#" data-toggle="modal" data-target="#confirm-modal"><i
                                            class="fa fa-close icon"></i>Delete</a></div>
                        </div>
                    </h3>
                    <p class="title-description"> List of properties - e.g. rooms, beds, etc, ... </p>
                </div>
            </div>
        </div>
        <div class="items-search">
            <form class="form-inline">
                <div class="input-group">
                    <input type="text" class="form-control rounded-s" placeholder="Search for...">
            ...
            <li class="item">
                <div class="item-row">
                    ...
                    <div class="item-col fixed item-col-img md">
                        <a href="{{ route('hostel.property.edit', ['property' => 'id']) }}">
                    ...
                    <div class="item-col fixed pull-left item-col-title">
                        ...
                        <div>
                            <a href="{{ route('hostel.property.edit', ['property' => 'id']) }}" class="">
                        ...
                        <div class="item-actions-dropdown"><a class="item-actions-toggle-btn">
                            ...
                            <div class="item-actions-block">
                                <ul class="item-actions-list">
                                    ...
                                    <li><a class="edit"
                                           href="{{ route('hostel.property.edit', ['property' => 'id']) }}">
            ...
            <li class="item">
                <div class="item-row">
                    ...
                    <div class="item-col fixed pull-left item-col-title">
                        ...
                        <div>
                            <a href="{{ route('hostel.property.edit', ['property' => 'id']) }}" class="">
                                <h4 class="item-title"> Vestibulum tincidunt amet laoreet mauris sit sem aliquam cras
                                    maecenas vel aliquam. </h4>
                            </a>
                        </div>
                    </div>
                    <div class="item-col item-col-sales">
