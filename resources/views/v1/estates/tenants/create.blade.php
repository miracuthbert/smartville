                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_no" class="form-control" placeholder="national id or passport #..."
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country" class="form-control" id="country" required>
                                        @forelse($countries as $country)
                                            <option value="{{ $country }}" {{ Request::old('country') == $country ? 'selected' : '' }}>
                                                {{ $country }}
                                            </option>
                                        @empty
                                            <option>Failed loading country lists</option>
                                        @endforelse
                                    </select>
                                </div>
                            </div>
