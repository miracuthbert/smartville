...
@section('breadcrumb')
    <li>Bills</li>
    <li>
        <a href="{{ route('estate.bills.services', ['id' => $app->id, 'sort' => 'all']) }}">Services</a>
    </li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form name="create-bill-form" method="post" action="{{ route('estate.bills.service.update') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="number" name="billing_interval" class="form-control"
                                   ...
                                   id="billing_interval" min="1" required/>
                        </div>
                        <div class="col-md-1">
                            <label>per</label>
                        </div>
                ...
                <div class="form-group">
                    <button type="submit" name="btnUpdateBillService" role="button" class="btn btn-primary">
                        Update
                    </button>
                </div>
