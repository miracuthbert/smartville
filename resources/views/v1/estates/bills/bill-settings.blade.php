        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-9">
                            <h4>{{ title_case($sort) }} Billing Services</h4>
                        </div>
                        <div class="col-md-3">
                            <nav>
                                <ul class="nav">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{ route('estate.bills.services', ['id' => $app->id, 'sort' => 'all']) }}">All</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('estate.bills.services', ['id' => $app->id, 'sort' => 'trashed']) }}">Trashed</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('estate.bills.services', ['id' => $app->id, 'sort' => 'active']) }}">Active</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('estate.bills.services', ['id' => $app->id, 'sort' => 'disabled']) }}">Disabled</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($bills as $bill)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('estate.bills.service.status', ['id' => $bill->id]) }}"
                                               role="button"
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-xs">
                                                @if($sort != "trashed")
                                                    <a href="{{ route('estate.bills.service.edit', ['id' => $bill->id]) }}"
                                                       role="button" class="btn btn-primary" data-toggle="tooltip"
                                                       title="edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    <a href="{{ route('estate.bills.service.delete', ['id' => $bill->id]) }}"
                                                       role="button" class="btn btn-warning" data-toggle="tooltip"
                                                       title="trash">
                                                        <i class="fa fa-remove"></i>
                                                    </a>
                                                @else
                                                    <a href="{{ route('estate.bills.service.restore', ['id' => $bill->id]) }}"
                                                       role="button" class="btn btn-success" data-toggle="tooltip"
                                                       title="restore">
                                                        <i class="fa fa-refresh"></i>
                                                    </a>

                                                    <a href="{{ route('estate.bills.service.destroy', ['id' => $bill->id]) }}"
