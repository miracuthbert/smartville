            ...
            <div class="pull-right">
                <div class="btn-group btn-group-xs">
                    ...
                    @if($notification->read_at != null)
                        <a href="{{ route('estate.rental.rents', ['id' => $app->id, 'sort' => 'pending', 'today' => $notification->data['is_today'], 'date' => $notification->created_at->toDateString()]) }}"
                           class="btn btn-default" data-toggle="tooltip" title="View invoices">
                            View
                        </a>
                    @else
                        <a href="{{ route('estate.rental.rents', ['id' => $app->id, 'sort' => 'pending', 'notify' => $notification->id, 'today' => $notification->data['is_today'], 'date' => $notification->created_at->toDateString()]) }}"
                           class="btn btn-default" data-toggle="tooltip" title="View invoices">
                            View
                        </a>
                    @endif
