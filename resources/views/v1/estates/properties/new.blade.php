...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form name="add-property-form" method="post" action="{{ route('estate.property.store') }}"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="name or number" id="title"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group{{ $errors->has('price') ? 'has-error' : '' }} input-group">
                            <input type="number" name="price" class="form-control" placeholder="rental price" min="0"
                                   step="50" maxlength="10" id="price" value="{{ Request::old('price') }}" required/>
                            <span class="input-group-addon">
                                .00
                            </span>
                            @if($errors->has('price'))
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group{{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea name="description" class="form-control" cols="30" rows="3" id="description"
                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <button type="submit" name="btnAddProperty" role="button"
                                    class="btn btn-success" {{ $app->subscribed != 1 ? 'disabled' : '' }}>Save
                            </button>
                        </div>
                    </div>
                </div>
