    ...
    <div class="panel panel-default">
            ...
            <div class="pull-right">
                <div class="btn-group btn-group-sm">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        @if($layout != null)
                            @include('v1.estates.properties.layouts.menu_grid')
                        @else
                            @include('v1.estates.properties.layouts.menu_default')
                        @endif
                    </ul>
                </div>
            </div>
        ...
        <div class="panel-body">
            @if(count($properties) > 0)
                @if($layout == null)
                    @include('v1.estates.properties.layouts.default')
                @else
                    @include('v1.estates.properties.layouts.grid')
                @endif
            @else
                <p class="text-info">
