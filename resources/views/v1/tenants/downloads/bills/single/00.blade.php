    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td class="col-md-6 text-right">
                ...
                <br>
                <strong>Sent On:</strong> {{ $bill->created_at->toDateString() }}
                <br>
                <strong>Payment Due:</strong> {{ $bill->date_due }}
                <br>
            </td><!-- /.col -->
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="col-md-6 text-right" style="border-top: 1px solid #cccccc">
                ...
                <address>
                    ...
                    <br>
                    <strong>Property:</strong> {{ $bill->property->title }}
                    <br>
        ...
        <tr>
            <td colspan="3">
                <h2 class="text-center"
                    ...
                    {{ strtoupper($bill->bill->title) }} BILL
                </h2>
