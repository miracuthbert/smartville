...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product = \App\Product::create(
            array('id' => '3', 'category_id' => '1', 'monetization_id' => '7', 'title' => 'Export Invoice To PDF', 'summary' => 'A feature that allows both tenants and property managers to download invoices in PDF format.', 'desc' => 'Allows exporting of invoices to PDF format.', 'app' => '1', 'icon' => 'fa-file-pdf-o', 'page' => '', 'version_name' => 'Venus', 'version_no' => '0.10', 'mode' => '0', 'coming_soon' => '1', 'status' => '0', 'created_at' => '2017-01-31 10:57:50', 'updated_at' => '2017-01-31 11:08:25', 'deleted_at' => NULL)
        );
    }
}
